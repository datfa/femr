...
public class DataModelMapper implements IDataModelMapper{
     ...
     */
    @Override
    public IPatient createPatient(int userID, String firstName, String lastName, Date birthday, String dobCertainty, String sex, String address, String city, Integer photoID) {
        ...
        patient.setDobCertainty(dobCertainty);
        patient.setSex(sex);
