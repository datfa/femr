...
public interface IDataModelMapper {
     ...
     * @param dorCertainty  the patients birthday real/fake, may be null
     ...
     */
    IPatient createPatient(int userID, String firstName, String lastName, Date birthday, String dorCertainty, String sex, String address, String city, Integer photoID);
